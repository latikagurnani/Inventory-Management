    ...
    {   if($_GET['q'] == 'success')
        {
            ...
            Successfully inserted a new Customer! </div>";
        }else if($_GET['q'] == 'error'){

            if($_GET['status'] == 'customer')
            {echo"<div class='alert alert-danger'>
            <button class='close' data-close='alert'></button>Contact no  alredy exist in customer  </div>";
            }
        }
...
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="textarea" name="customer_address" class="form-control" placeholder="Customer Address">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Customer Email </label>
                                            <div class="col-md-4">
                                                <input name="customer_email" type="text" class="form-control" placeholder="Customer Email" /> </div>
