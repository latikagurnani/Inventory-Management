                                                    ...
                                                    <div class="row">
                                                        <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/product/edit.php" method="POST">
                                                            <div class="form-body">
                                                                ...
                                                                <div class="form-group clearfix">
                                                                    <label class="control-label col-md-3">Additional Specification
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-9">
                                                                        <input type="text" id="gst_rate" name="gst_rate" class="form-control" placeholder="GST Rate" readonly /> </div>
                                                                ...
                                                                <div class="form-group clearfix">
                                                                    <label class="control-label col-md-3">Ctegory Name
                                                                        <span class="required"> * </span>
                                                                    </label>
                                                                    <div class="col-md-9">
                                                                        <input type="text" id="gst_rate" name="gst_rate" class="form-control" placeholder="GST Rate" readonly /> </div>
...
<![endif]-->
            ...
            <script>
                toastr["success"]("You have successfully edited!!!", "Categor Edit")
