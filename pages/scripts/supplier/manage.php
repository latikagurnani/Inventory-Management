...
if(isset($_POST["search"]["value"])){
    $query .= " AND (supplier_name like '%".$_POST["search"]["value"]."%' OR  supplier_email like '%". $_POST['search']['value']."%' OR supplier_contact like '%". $_POST['search']['value']."%' OR gst_no like '%". $_POST['search']['value']."%')"; 
}
