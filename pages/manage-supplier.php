                                                        ...
                                                        <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/supplier/edit.php" method="POST">
                                                            <div class="form-body">
                                                                ...
                                                                <div class="form-group clearfix">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" id="supplier_address" name="supplier_address" class="form-control" placeholder="Supplier Address" /> </div>
                                                                </div>
                                                                <div class="form-group clearfix">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" id="supplier_email" name="supplier_email" class="form-control" placeholder="Supplier Email" /> </div>
                                                                </div>
                                                                <div class="form-group clearfix">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" id="supplier_contact" name="supplier_contact" class="form-control" placeholder=" Supplier Contact"/> </div>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button id="edit_save" type="submit" class="btn btn-primary" name="edit_supplier">Save changes</button>
                                                                </div>
...
<![endif]-->
            ...
            <script>
                toastr["success"]("You have successfully edited!!!", "SupplierEdit")
